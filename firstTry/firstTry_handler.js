...
const FirstTry_FAMILY = 'FirstTry'
const FirstTry_NAMESPACE = _hash(FirstTry_FAMILY).substring(0, 6)
...
class FirstTryHandler extends TransactionHandler {
  constructor () {
    super(FirstTry_FAMILY, ['1.0'], [FirstTry_NAMESPACE])
  }
  ...
  apply (transactionProcessRequest, context) {
    return _decodeCbor(transactionProcessRequest.payload)
      ...
      .then((update) => {
        ...
        let address = FirstTry_NAMESPACE + _hash(name).slice(-64)
...
module.exports = FirstTryHandler